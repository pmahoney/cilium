...
func init() {
	...
	flags.DurationVar(&cnpStatusUpdateInterval, "cnp-status-update-interval", 100*time.Millisecond, "interval between CNP status updates sent to the k8s-apiserver per-CNP")
